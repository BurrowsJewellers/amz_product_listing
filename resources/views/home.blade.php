...
<body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            ...
                            <a class="dropdown-item" href="#">
                                ...
                                Messages<span class="badge badge-sm bg-success ms-2">42</span></a><a
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    <div class="clearfix">
                                                        ...
                                                        <div class="float-end">
                                                            <small class="text-medium-emphasis">Jun 11,
                                                                2020 - Jul
                                                                10,
                                                                2020</small>
                                                        </div>
                                                ...
                                                <td class="text-center">
                                                    <div class="avatar avatar-md">
                                                        <img class="avatar-img" src="assets/img/avatars/2.jpg"
                                                            alt="user@email.com" /><span
                                                            class="avatar-status bg-danger"></span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                ...
                                                <td class="text-center">
                                                    <div class="avatar avatar-md">
                                                        <img class="avatar-img" src="assets/img/avatars/3.jpg"
                                                            alt="user@email.com" /><span
                                                            class="avatar-status bg-warning"></span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>Quintin Ed</div>
                                                ...
                                                <td class="text-center">
                                                    <div class="avatar avatar-md">
                                                        <img class="avatar-img" src="assets/img/avatars/4.jpg"
                                                            alt="user@email.com" /><span
                                                            class="avatar-status bg-secondary"></span>
                                                    </div>
                                                </td>
                                                <td>
        ...
        <footer class="footer">
            <div>
                <a href="https://coreui.io">CoreUI </a><a href="https://coreui.io">Bootstrap Admin Template</a> ©
                2022 creativeLabs.
            </div>
            <div class="ms-auto">
