...
class GetProductsREST extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'shopifyGetProductsREST';
     ...
     * @var string
     */
    protected $description = 'Get Shopify products using REST API (backup version)';
